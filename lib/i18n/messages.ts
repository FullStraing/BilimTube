...
const messagesByLocale: Record<Locale, Messages> = {
  ru: {
    ...
    'shorts.categoriesSelected': 'категории',
    ...
    'video.similarEmpty': 'Пока похожих видео нет.',
    'common.years': 'лет',
  ...
  ky: {
    ...
    'shorts.mute': 'Добушту өчүрүү',
    'shorts.unmute': 'Добушту кошуу',
    'shorts.loadError': 'Shorts жүктөө мүмкүн болгон жок. Баракты жаңыртып көрүңүз.',
    ...
    'quiz.defaultTitle': 'Тест: {title}',
    'video.quizCtaTitle': 'Видеодон тест өтүңүз!',
    'video.quizCtaSubtitle': 'Билимиңизди текшериңиз',
